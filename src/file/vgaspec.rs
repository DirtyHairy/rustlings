...
use super::{encoding, palette::PALETTE_FIXED, sprite::Bitmap};
...
pub struct Content {
    pub palette: [(usize, usize, usize); 16],
    pub bitmap: Bitmap,
}
...
impl Content {
    pub fn read_data(compressed_data: &[u8]) -> Result<Content> {
        ...
        for _i in 0..4 {
            ...
            section_bitmaps.push(Bitmap::read_planar(
                ...
                3,
                &bitmap_data,
                super::sprite::TransparencyEncoding::Black,
            )?)
        }
